...
helpMessage ="""BOT By 1DaffaN3Kalani
...
admin=["u82f7bb98715417c34fe1b7fac263e893","u05b001551c897ad6a6e2ca6cecccd32e"]
creator=["u82f7bb98715417c34fe1b7fac263e893"]
wait = {
    'contact':False,
    'autoJoin':True,
						...
						if targets == []:
							...
							for target in targets:
									try:
										...
										ki.sendText(msg.to,"Succes Boss")
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u82f7bb98715417c34fe1b7fac263e893"}
					cl.sendMessage(msg)
#-----------------------------------------------
                ...
                if msg.from_ in creator:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.remove(target)
                                cl.sendText(msg.to,"Admin Remove")
                            except:
                                pass
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By 1DaffaN3Kalani\n\nhttp://line.me/ti/p/H2VZm0LFeR")
						print "DiLike"
					except:
							pass
				else:
